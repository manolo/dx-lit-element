package es.manolo.litelement.views.list;
...
@Tag("list-view")
public class ListView extends LitTemplate implements AfterNavigationObserver {

    // This is the Java companion file of a design
    // You can find the design file in /frontend/src/views/views/list/list-view.js
    ...
    public void afterNavigation(AfterNavigationEvent event) {
        ...
        getElement().setPropertyList("items", clients);
    }
