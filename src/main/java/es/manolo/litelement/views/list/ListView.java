...
import es.manolo.litelement.views.list.ListView.ListViewModel;

@Route(value = "list")
@PageTitle("List")
@JsModule("./views/list/list-view.js")
@Tag("list-view")
public class ListView extends PolymerTemplate<ListViewModel> implements
     ...
     * framework.
     */
    public static interface ListViewModel extends TemplateModel {
