package es.manolo.litelement.views.dashboard;
...
@Tag("dashboard-view")
public class DashboardView extends LitTemplate implements
    ...
    public void afterNavigation(AfterNavigationEvent event) {
        ...
        // Top row widgets
        getElement().setProperty("currentUsers", 745);
        getElement().setProperty("numEvents", "54.6k"); // TODO client-side formatting
        getElement().setProperty("conversionRate", 18);
